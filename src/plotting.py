...
def plotting_setup_dft_ddft(df, selected, df_out: str = "plots/ddft_study.pkl"):
    ...
    df['SAPT0_atz_3_IE'] = (df['SAPT0 ELST ENERGY'] + df['SAPT0 EXCH ENERGY'] + df['SAPT0 IND ENERGY']) * h2kcalmol
    df['SAPT0_atz_total'] = (df['SAPT0 ELST ENERGY'] + df['SAPT0 EXCH ENERGY'] + df['SAPT0 IND ENERGY'] +df["SAPT0 DISP ENERGY"]) * h2kcalmol
    ...
    plot_violin_SAPT0_DFT_components(
        ...
        elst_vals={
            "name": "Electrostatics",
            "reference": [f"{reference}/aTZ Ref.", f"{reference} ELST ENERGY"],
            "vals": {
        ...
        exch_vals={
            "name": "Exchange",
            "reference": [f"{reference}/aTZ Ref.", f"{reference} EXCH ENERGY"],
            "vals": {
        ...
        indu_vals={
            "name": "Induction",
            "reference": [f"{reference}/aTZ Ref.", f"{reference} IND ENERGY"],
            "vals": {
        ...
        disp_vals={
            "name": "Dispersion",
            "reference": [f"{reference}/aTZ Ref.", f"{reference} DISP ENERGY"],
            "vals": {
        ...
        total_vals={
            ...
            "vals": {
                ...
                "SAPT2+3(CCD)DMP2/aTZ": "SAPT2+3(CCD)DMP2 TOTAL ENERGY",
